...
var api = {
  ...
  token: "42d1e0f466a7f6d98d603523c838ddb0", // TODO 0 add your api key
...
function render() {
  ...
  model.watchlistItems.forEach(function(movie) {
    ...
    var watchedBtn = $('<button></button>').text('I Watched It!').attr("class", "btn btn-danger")
    .click(function() {
        var removeMovie = model.watchlistItems.indexOf(movie);
        model.watchlistItems.splice(removeMovie, 1);
        render();
    });
    // TODO 2i
